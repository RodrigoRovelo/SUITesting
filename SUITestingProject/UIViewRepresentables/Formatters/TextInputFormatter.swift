...
class TextInputFormatter {
    ...
    func formatInput(currentText: String, range: NSRange, replacementString text: String) -> FormattedText {
    ...
    func format(_ unformattedText: String?, textPattern: String) -> String? {
        textFormatter.modifyTextPattern(with: textPattern)
